...
if len(analysis_reviews) > 0:
    ...
    avg_rating = float(analysis_reviews['rating'].mean())
    ...
    lang_dist = {k: int(v) for k, v in lang_dist.items()}
    ...
    finding1 = {
        ...
        "metrics": {
            ...
            "five_star_count": {
                "value": int(rating_dist.get(5, 0)),
                "unit": "count",
                "numerator": int(rating_dist.get(5, 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "one_star_count": {
                "value": int(rating_dist.get(1, 0)),
                "unit": "count",
                "numerator": int(rating_dist.get(1, 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            }
...
if len(analysis_reviews) > 0:
    ...
    topic_dist = {k: int(v) for k, v in topic_dist.items()}
    ...
    finding2 = {
        ...
        "metrics": {
            "positive_sentiment_count": {
                ...
                "unit": "count",
                "numerator": int(sentiment_dist.get('positive', 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "neutral_sentiment_count": {
                ...
                "unit": "count",
                "numerator": int(sentiment_dist.get('neutral', 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "negative_sentiment_count": {
                ...
                "unit": "count",
                "numerator": int(sentiment_dist.get('negative', 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
        ...
        "coverage_notes": [
            ...
            f"Topics identified: {topic_dist if topic_dist else 'None'}"
        ],
        "assumptions": [
...
if len(previous_reviews) > 0 and len(analysis_reviews) > 0:
    prev_avg_rating = float(previous_reviews['rating'].mean())
    curr_avg_rating = float(analysis_reviews['rating'].mean())
    ...
    finding3 = {
        ...
        "metrics": {
            "previous_period_avg_rating": {
                ...
                "unit": "stars",
                "numerator": round(float(previous_reviews['rating'].sum()), 2),
