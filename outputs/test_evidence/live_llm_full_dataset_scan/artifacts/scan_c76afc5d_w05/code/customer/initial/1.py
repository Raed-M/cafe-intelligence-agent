...
if len(reviews_analysis) > 0:
    ...
    finding1 = {
        ...
        "claim": f"During the analysis period, customers provided {len(reviews_analysis)} reviews with an average rating of {avg_rating:.2f} out of 5. Rating distribution shows {rating_counts.to_dict()} across the scale.",
...
if len(reviews_analysis) > 0:
    ...
    positive_count = (reviews_analysis['sentiment'] == 'positive').sum()
    negative_count = (reviews_analysis['sentiment'] == 'negative').sum()
    neutral_count = (reviews_analysis['sentiment'] == 'neutral').sum()
    ...
    finding2 = {
        ...
        "metrics": {
            ...
            "positive_sentiment_rate": {
                "value": round(positive_count / len(reviews_analysis) * 100, 1),
                "unit": "percent",
                "numerator": positive_count,
                "denominator": len(reviews_analysis),
                "period_start": "2026-02-09T00:00:00+03:00",
        ...
        finding3 = {
            ...
            "metrics": {
                ...
                "week_over_week_change": {
                    ...
                    "unit": "percent",
                    "numerator": analysis_count - previous_count,
            ...
            "sample_size": analysis_count + previous_count,
            "coverage_notes": [
