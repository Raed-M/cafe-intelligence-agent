...
previous_start = tz.localize(datetime(2026, 5, 4, 0, 0, 0))
previous_end = tz.localize(datetime(2026, 5, 11, 0, 0, 0))
...
previous_traffic = traffic_df[(traffic_df['date'] >= previous_start.date()) & (traffic_df['date'] < previous_end.date())]
...
analysis_staff = staff_df[(staff_df['date'] >= analysis_start.date()) & (staff_df['date'] < analysis_end.date())]
previous_staff = staff_df[(staff_df['date'] >= previous_start.date()) & (staff_df['date'] < previous_end.date())]
