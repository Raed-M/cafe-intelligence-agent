...
if len(valid_items) > 0:
    ...
    finding_1 = {
        ...
        "claim": f"{top_item['item_name']} generated {top_item['gross_profit_sar']:.2f} SAR gross profit from {int(top_item['units_sold'])} units sold at {top_item['revenue_sar']:.2f} SAR revenue during 2026-05-11 to 2026-05-18, based on menu-declared unit cost of {top_item['unit_cost_sar']:.1f} SAR (no recipe/BOM verification available).",
    ...
    finding_2 = {
        ...
        "metrics": {
            "old_price_sar": {
                ...
                "numerator": None,
                "denominator": None,
                "period_start": eff_date.isoformat(),
                "period_end": eff_date.isoformat()
            },
            "new_price_sar": {
...
if len(waste_items) > 0:
    ...
    finding_3 = {
        ...
        "coverage_notes": [
            ...
            f"Waste cost ranking (top 3): {waste_ranking.head(3)[['item', 'waste_cost_sar']].to_dict('records')}",
