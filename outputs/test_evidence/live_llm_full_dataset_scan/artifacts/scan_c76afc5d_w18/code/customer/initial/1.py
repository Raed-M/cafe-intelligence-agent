...
average_rating = analysis_reviews['rating'].mean()
...
english_count = len(english_reviews)
arabic_count = len(arabic_reviews)
...
if total_reviews > 0:
    finding1 = {
        ...
        "claim": f"During the analysis period, {total_reviews} reviews were collected with an average rating of {average_rating:.2f} out of 5. The distribution shows {rating_distribution.get(5, 0)} 5-star, {rating_distribution.get(4, 0)} 4-star, {rating_distribution.get(3, 0)} 3-star, {rating_distribution.get(2, 0)} 2-star, and {rating_distribution.get(1, 0)} 1-star ratings.",
        ...
        "metrics": {
            ...
            "five_star_count": {
                "value": rating_distribution.get(5, 0),
                "unit": "count",
                "numerator": rating_distribution.get(5, 0),
                "denominator": total_reviews,
                "period_start": "2026-05-11T00:00:00+03:00",
                "period_end": "2026-05-18T00:00:00+03:00"
            },
            "four_star_count": {
                "value": rating_distribution.get(4, 0),
                "unit": "count",
                "numerator": rating_distribution.get(4, 0),
                "denominator": total_reviews,
                "period_start": "2026-05-11T00:00:00+03:00",
                "period_end": "2026-05-18T00:00:00+03:00"
            },
            "three_star_count": {
                "value": rating_distribution.get(3, 0),
                "unit": "count",
                "numerator": rating_distribution.get(3, 0),
                "denominator": total_reviews,
                "period_start": "2026-05-11T00:00:00+03:00",
                "period_end": "2026-05-18T00:00:00+03:00"
            },
            "two_star_count": {
                "value": rating_distribution.get(2, 0),
                "unit": "count",
                "numerator": rating_distribution.get(2, 0),
                "denominator": total_reviews,
                "period_start": "2026-05-11T00:00:00+03:00",
                "period_end": "2026-05-18T00:00:00+03:00"
            },
            "one_star_count": {
                "value": rating_distribution.get(1, 0),
                "unit": "count",
                "numerator": rating_distribution.get(1, 0),
                "denominator": total_reviews,
                "period_start": "2026-05-11T00:00:00+03:00",
                "period_end": "2026-05-18T00:00:00+03:00"
            }
...
if high_rating_count > 0 or low_rating_count > 0:
    ...
    finding3 = {
        ...
        "coverage_notes": [
            ...
            f"Neutral reviews (3 stars): {rating_distribution.get(3, 0)}",
