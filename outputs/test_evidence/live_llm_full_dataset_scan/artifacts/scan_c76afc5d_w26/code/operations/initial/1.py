...
# Analysis period
analysis_start = pd.Timestamp('2026-07-06', tz=tz)
analysis_end = pd.Timestamp('2026-07-13', tz=tz)
previous_start = pd.Timestamp('2026-06-29', tz=tz)
previous_end = pd.Timestamp('2026-07-06', tz=tz)
