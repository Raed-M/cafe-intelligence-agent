        ...
        finding3 = {
            ...
            "metrics": {
                "ingredient": {
                    ...
                    "period_end": latest_change['effective_date'].isoformat()
                },
                "old_price": {
                ...
                "effective_date": {
                    "value": latest_change['effective_date'].isoformat(),
                    "unit": None,
                    "numerator": None,
                    "denominator": None,
                    "period_start": latest_change['effective_date'].isoformat(),
            ...
            "coverage_notes": [
                ...
                f"Latest change effective: {latest_change['effective_date'].isoformat()}",
