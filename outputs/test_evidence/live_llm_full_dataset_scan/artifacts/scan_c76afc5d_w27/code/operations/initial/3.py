...
valid_transactions_prev = int(pos_prev[~pos_prev['is_refund']]['transaction_id'].nunique())
...
footfall_prev = int(traffic_prev_valid['door_count'].sum())
...
analysis_days = int(len(staff_analysis['date'].unique()))
prev_days = int(len(staff_prev['date'].unique()))
...
pos_analysis_revenue = float(pos_analysis[~pos_analysis['is_refund']]['line_total_sar'].sum())
pos_prev_revenue = float(pos_prev[~pos_prev['is_refund']]['line_total_sar'].sum())
...
total_waste_cost_analysis = float(inv_analysis['known_waste_cost_sar'].sum())
total_waste_cost_prev = float(inv_prev['known_waste_cost_sar'].sum())

total_revenue_analysis = float(pos_analysis[~pos_analysis['is_refund']]['line_total_sar'].sum())
total_revenue_prev = float(pos_prev[~pos_prev['is_refund']]['line_total_sar'].sum())
