...
# Remove timezone info from analysis dates for comparison with potentially tz-naive data
analysis_start_dt_naive = analysis_start_dt.tz_localize(None)
analysis_end_dt_naive = analysis_end_dt.tz_localize(None)

# If reviews have timezone info, convert to naive; if already naive, keep as is
