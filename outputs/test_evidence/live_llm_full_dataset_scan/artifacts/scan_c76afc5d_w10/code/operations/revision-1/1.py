...
analysis_start = tz.localize(datetime(2026, 3, 16, 0, 0, 0))
analysis_end = tz.localize(datetime(2026, 3, 23, 0, 0, 0))
previous_start = tz.localize(datetime(2026, 3, 9, 0, 0, 0))
previous_end = tz.localize(datetime(2026, 3, 16, 0, 0, 0))
...
if conversion_analysis is not None and conversion_previous is not None and conversion_previous > 0:
    ...
    result_metrics['conversion_change_percent'] = {
...
if labour_cost_analysis > 0 and demand_analysis > 0:
    ...
    result_metrics['labour_cost_analysis'] = {
    ...
    result_metrics['demand_analysis'] = {
    ...
    result_metrics['labour_to_demand_ratio_analysis'] = {
    ...
    if labour_to_demand_previous is not None:
        result_metrics['labour_to_demand_ratio_previous'] = {
        ...
        result_metrics['labour_to_demand_ratio_change_percent'] = {
...
if len(inventory_analysis) > 0:
    ...
    if len(inventory_previous) > 0:
        ...
        if units_sold_analysis > 0 and units_sold_previous > 0:
            ...
            result_metrics['waste_ratio_change_percent'] = {
