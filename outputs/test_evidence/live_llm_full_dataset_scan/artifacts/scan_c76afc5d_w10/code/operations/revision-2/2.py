...
if conversion_rate_previous > 0 and total_footfall_analysis > 0:
    findings.append({
        ...
        "coverage_notes": [
            ...
            f"Total footfall: {int(total_footfall_analysis + total_footfall_previous)} visitors"
        ],
        "assumptions": [
    ...
    findings.append({
        ...
        "metrics": {
            ...
            "waste_ratio_analysis_period": {
                ...
                "denominator": int(units_sold_analysis),
                "period_start": analysis_start.isoformat(),
                "period_end": analysis_end.isoformat()
            },
            ...
            "waste_ratio_previous_period": {
                ...
                "denominator": int(units_sold_previous),
                "period_start": previous_start.isoformat(),
                "period_end": previous_end.isoformat()
            },
        ...
        "coverage_notes": [
            f"Analysis period (2026-03-16 to 2026-03-23): {len(inventory_analysis)} inventory records, {int(units_sold_analysis)} units sold",
            f"Previous period (2026-03-09 to 2026-03-16): {len(inventory_previous)} inventory records, {int(units_sold_previous)} units sold",
