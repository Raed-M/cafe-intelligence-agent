...
analysis_start = pd.Timestamp('2026-01-19', tz=tz)
analysis_end = pd.Timestamp('2026-01-26', tz=tz)
previous_start = pd.Timestamp('2026-01-12', tz=tz)
previous_end = pd.Timestamp('2026-01-19', tz=tz)
