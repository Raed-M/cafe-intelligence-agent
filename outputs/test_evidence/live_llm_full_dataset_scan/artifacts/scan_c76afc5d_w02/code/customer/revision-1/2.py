        ...
        finding2 = {
            ...
            "metrics": {
                ...
                "positive_reviews_with_text": {
                    ...
                    "denominator": len(positive_reviews) if len(positive_reviews) > 0 else None,
                    "period_start": analysis_start,
                    "period_end": analysis_end
                },
                "negative_reviews_with_text": {
                    ...
                    "denominator": len(negative_reviews) if len(negative_reviews) > 0 else None,
                    "period_start": analysis_start,
                    "period_end": analysis_end
                }
            },
...
if len(analysis_reviews) > 0:
    ...
    finding3 = {
        ...
        "claim": f"During the analysis period, reviews were collected from {len(source_distribution)} sources: {', '.join(sorted(source_distribution.index.tolist()))}. The distribution shows {source_distribution.to_dict()}.",
