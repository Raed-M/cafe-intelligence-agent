...
if total_reviews > 0:
    finding1 = {
        ...
        "claim": f"Average rating is {avg_rating:.2f} out of 5 across {total_reviews} reviews. Rating distribution shows {convert_to_native(rating_counts.get(5, 0))} 5-star, {convert_to_native(rating_counts.get(4, 0))} 4-star, {convert_to_native(rating_counts.get(3, 0))} 3-star, {convert_to_native(rating_counts.get(2, 0))} 2-star, and {convert_to_native(rating_counts.get(1, 0))} 1-star reviews.",
        ...
        "metrics": {
            ...
            "five_star_count": {
                "value": int(convert_to_native(rating_counts.get(5, 0))),
                "unit": "count",
                "numerator": None,
                "denominator": None,
                "period_start": "2026-01-26T00:00:00+03:00",
            ...
            "four_star_count": {
                "value": int(convert_to_native(rating_counts.get(4, 0))),
                "unit": "count",
                "numerator": None,
                "denominator": None,
                "period_start": "2026-01-26T00:00:00+03:00",
            ...
            "three_star_count": {
                "value": int(convert_to_native(rating_counts.get(3, 0))),
                "unit": "count",
                "numerator": None,
                "denominator": None,
                "period_start": "2026-01-26T00:00:00+03:00",
            ...
            "two_star_count": {
                "value": int(convert_to_native(rating_counts.get(2, 0))),
                "unit": "count",
                "numerator": None,
                "denominator": None,
                "period_start": "2026-01-26T00:00:00+03:00",
            ...
            "one_star_count": {
                "value": int(convert_to_native(rating_counts.get(1, 0))),
                "unit": "count",
                "numerator": None,
                "denominator": None,
                "period_start": "2026-01-26T00:00:00+03:00",
...
if total_reviews > 0:
    positive_count = int(convert_to_native(sentiment_counts.get('positive', 0)))
    neutral_count = int(convert_to_native(sentiment_counts.get('neutral', 0)))
    negative_count = int(convert_to_native(sentiment_counts.get('negative', 0)))
...
if len(topic_counts) > 0:
    ...
    for topic, count in top_topics:
        topic_metrics[f"{topic}_mentions"] = {
            "value": int(convert_to_native(count)),
            "unit": "count",
            "numerator": int(convert_to_native(count)),
            "denominator": len(reviews_analysis),
            "period_start": "2026-01-26T00:00:00+03:00",
            "period_end": "2026-02-02T00:00:00+03:00"
        }
    
    top_topics_str = ", ".join([f"{topic} ({int(convert_to_native(count))} mentions)" for topic, count in top_topics])
