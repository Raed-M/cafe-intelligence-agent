...
if total_with_topics > 0 and len(top_topics) > 0:
    ...
    finding2 = {
        ...
        "source_names": list(reviews_with_topics['source'].unique()),
        ...
        "coverage_notes": [
            ...
            f"Language coverage: {dict(reviews_with_topics['language'].value_counts())}"
        ],
        "assumptions": [
            "Empty or missing review text is excluded from topic analysis",
            "Keyword matching approach may miss nuanced or implicit topic references",
