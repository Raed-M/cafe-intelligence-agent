...
sku_comparison['valid_for_comparison'] = (
    (sku_comparison['launch_date'].isna() | (sku_comparison['launch_date'] <= previous_start)) &
    (sku_comparison['retire_date'].isna() | (sku_comparison['retire_date'] > analysis_end))
)
...
if previous_daily_revenue != 0:
    ...
    findings.append({
        ...
        "claim": f"Daily average revenue in analysis period (2026-01-26 to 2026-02-02) was SAR {analysis_daily_revenue:.2f}, compared to SAR {previous_daily_revenue:.2f} in previous period (2026-01-19 to 2026-01-26), representing a {daily_revenue_pct_change:.2f}% change. Analysis period spans 8 days while previous period spans 7 days; daily normalization enables fair comparison.",
        ...
        "coverage_notes": [
            ...
            "Revenue includes refunds as negative values (net calculation)",
...
if previous_aov != 0:
    findings.append({
        ...
        "claim": f"Average order value in analysis period was SAR {analysis_aov:.2f}, compared to SAR {previous_aov:.2f} in previous period, representing a {aov_pct_change:.2f}% change. This decline reflects lower average basket values despite stable transaction volumes.",
        ...
        "assumptions": [
            ...
            "line_total_sar represents net transaction value",
            "is_refund flag correctly identifies refund transactions",
            "AOV comparison is valid across equal-length periods"
        ],
        "confidence": 0.88
    })
