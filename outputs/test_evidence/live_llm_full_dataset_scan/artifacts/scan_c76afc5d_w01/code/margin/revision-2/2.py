...
# Remove timezone info for comparison with tz-naive columns
...
pos_analysis = pos_df[(pos_df['timestamp'] >= analysis_start_naive) & (pos_df['timestamp'] < analysis_end_naive)].copy()

# Filter inventory to analysis period
inventory_analysis = inventory_df[(inventory_df['week_starting'] >= analysis_start_naive) & (inventory_df['week_starting'] < analysis_end_naive)].copy()
