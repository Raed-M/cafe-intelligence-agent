...
if len(reviews_analysis) > 0:
    ...
    finding_1 = {
        ...
        "claim": f"During {analysis_start} to {analysis_end}, {int(len(reviews_analysis))} reviews were collected with an average rating of {float(avg_rating):.2f} out of 5.0.",
...
if len(reviews_analysis) > 0:
    finding_2 = {
        ...
        "claim": f"Among {int(len(reviews_analysis))} reviews in the analysis period, sentiment distribution shows {int(sentiment_counts.get('positive', 0))} positive, {int(sentiment_counts.get('neutral', 0))} neutral, and {int(sentiment_counts.get('negative', 0))} negative reviews. English reviews: {int(len(reviews_en))}, Arabic reviews: {int(len(reviews_ar))}.",
        ...
        "metrics": {
            ...
            "english_reviews": {
                "value": int(len(reviews_en)),
                "unit": "count",
                "numerator": int(len(reviews_en)),
                "denominator": int(len(reviews_analysis)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "arabic_reviews": {
                "value": int(len(reviews_ar)),
                "unit": "count",
                "numerator": int(len(reviews_ar)),
                "denominator": int(len(reviews_analysis)),
                "period_start": analysis_start,
                "period_end": analysis_end
            }
        ...
        "coverage_notes": [
            ...
            f"Language coverage: {int(len(reviews_en))} English, {int(len(reviews_ar))} Arabic",
...
if len(reviews_analysis) > 0:
    ...
    finding_3 = {
        ...
        "claim": f"In the analysis period, {int(len(high_rating_reviews))} reviews ({float(high_pct):.1f}%) were rated 4-5 stars (high satisfaction), while {int(len(low_rating_reviews))} reviews ({float(low_pct):.1f}%) were rated 1-2 stars (low satisfaction).",
        "finding_type": "rating_frequency",
        "metrics": {
            "high_rating_count": {
                "value": int(len(high_rating_reviews)),
                "unit": "count",
                "numerator": int(len(high_rating_reviews)),
                "denominator": int(len(reviews_analysis)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "high_rating_percentage": {
                "value": float(round(high_pct, 1)),
                "unit": "percent",
                "numerator": int(len(high_rating_reviews)),
                "denominator": int(len(reviews_analysis)),
                "period_start": analysis_start,
            ...
            "low_rating_count": {
                "value": int(len(low_rating_reviews)),
                "unit": "count",
                "numerator": int(len(low_rating_reviews)),
                "denominator": int(len(reviews_analysis)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "low_rating_percentage": {
                "value": float(round(low_pct, 1)),
                "unit": "percent",
                "numerator": int(len(low_rating_reviews)),
                "denominator": int(len(reviews_analysis)),
                "period_start": analysis_start,
