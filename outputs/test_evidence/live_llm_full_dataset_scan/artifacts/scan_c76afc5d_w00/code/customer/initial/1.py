...
if len(reviews_analysis) > 0:
    ...
    if len(arabic_reviews) > 0:
        ar_texts = arabic_reviews[arabic_reviews['text'].notna()]['text'].lower()
        ...
        finding2 = {
            ...
            "metrics": {
                "english_positive_count": {
                    "value": en_sentiment_counts.get('positive', 0),
                    "unit": "reviews",
                    "numerator": en_sentiment_counts.get('positive', 0),
                    "denominator": total_en if total_en > 0 else None,
                    "period_start": "2026-01-05T00:00:00+03:00",
                    "period_end": "2026-01-12T00:00:00+03:00"
                },
                "english_negative_count": {
                    "value": en_sentiment_counts.get('negative', 0),
                    "unit": "reviews",
                    "numerator": en_sentiment_counts.get('negative', 0),
                    "denominator": total_en if total_en > 0 else None,
                    "period_start": "2026-01-05T00:00:00+03:00",
                    "period_end": "2026-01-12T00:00:00+03:00"
                },
                "arabic_positive_count": {
                    "value": ar_sentiment_counts.get('positive', 0),
                    "unit": "reviews",
                    "numerator": ar_sentiment_counts.get('positive', 0),
                    "denominator": total_ar if total_ar > 0 else None,
                    "period_start": "2026-01-05T00:00:00+03:00",
                    "period_end": "2026-01-12T00:00:00+03:00"
                },
                "arabic_negative_count": {
                    "value": ar_sentiment_counts.get('negative', 0),
                    "unit": "reviews",
                    "numerator": ar_sentiment_counts.get('negative', 0),
                    "denominator": total_ar if total_ar > 0 else None,
                    "period_start": "2026-01-05T00:00:00+03:00",
                    "period_end": "2026-01-12T00:00:00+03:00"
                }
        ...
        finding3 = {
            ...
            "metrics": {
                "top_source_review_count": {
                    "value": top_source_count,
                    "unit": "reviews",
                    "numerator": top_source_count,
                    "denominator": len(reviews_analysis),
                    "period_start": "2026-01-05T00:00:00+03:00",
                    "period_end": "2026-01-12T00:00:00+03:00"
                },
                "top_source_average_rating": {
                    "value": round(top_source_avg_rating, 2),
                    "unit": "stars",
                    "numerator": round(top_source_avg_rating * top_source_count, 2),
                    "denominator": top_source_count,
                    "period_start": "2026-01-05T00:00:00+03:00",
                    "period_end": "2026-01-12T00:00:00+03:00"
                },
                "source_percentage": {
                    "value": round(top_source_count/len(reviews_analysis)*100, 1),
                    "unit": "percent",
                    "numerator": top_source_count,
                    "denominator": len(reviews_analysis),
                    "period_start": "2026-01-05T00:00:00+03:00",
