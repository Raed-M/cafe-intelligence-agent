...
item_metrics.columns = ['sku', 'total_quantity', 'total_revenue', 'unit_price', 'unit_cost', 'item_name', 'category']
    ...
    finding3 = {
        ...
        "metrics": {
            "ingredient": {
                ...
                "numerator": None,
                "denominator": None,
                "period_start": recent_change['effective_date'],
                "period_end": recent_change['effective_date']
            },
            "old_price": {
                "value": old_price,
