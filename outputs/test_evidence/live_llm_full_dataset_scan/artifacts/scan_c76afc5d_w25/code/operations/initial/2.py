...
# Analysis period
analysis_start = pd.Timestamp('2026-06-29')
analysis_end = pd.Timestamp('2026-07-06')
previous_start = pd.Timestamp('2026-06-22')
previous_end = pd.Timestamp('2026-06-29')
...
previous_labour_cost = staff_df[(staff_df['date'] >= previous_start) & (staff_df['date'] < previous_end)]['labour_cost_sar'].sum()
