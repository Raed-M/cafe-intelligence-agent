...
# Analysis period
analysis_start = pd.Timestamp('2026-06-29', tz=tz)
analysis_end = pd.Timestamp('2026-07-06', tz=tz)
previous_start = pd.Timestamp('2026-06-22', tz=tz)
previous_end = pd.Timestamp('2026-06-29', tz=tz)
...
previous_labour_cost = staff_df[(staff_df['date'] >= previous_start.date()) & (staff_df['date'] < previous_end.date())]['labour_cost_sar'].sum()
...
analysis_week = pd.Timestamp('2026-06-29', tz=tz)
