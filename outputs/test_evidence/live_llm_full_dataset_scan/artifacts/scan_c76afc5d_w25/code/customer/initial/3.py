...
target_tz = reviews_df['date'].dt.tz if reviews_df['date'].dt.tz is not None else None
if target_tz is not None:
    analysis_start_dt = analysis_start_dt.tz_convert(target_tz)
    analysis_end_dt = analysis_end_dt.tz_convert(target_tz)
