...
analysis_start = datetime(2026, 5, 25, 0, 0, 0, tzinfo=tz)
analysis_end = datetime(2026, 6, 1, 0, 0, 0, tzinfo=tz)
prev_start = datetime(2026, 5, 18, 0, 0, 0, tzinfo=tz)
prev_end = datetime(2026, 5, 25, 0, 0, 0, tzinfo=tz)
