...
if len(analysis_category_revenue) > 0 and len(previous_category_revenue) > 0:
    ...
    if top_category_analysis and top_category_analysis in previous_category_revenue.index:
        analysis_top_rev = analysis_category_revenue[top_category_analysis]
        previous_top_rev = previous_category_revenue[top_category_analysis]
        ...
        analysis_total_rev = analysis_category_revenue.sum()
        previous_total_rev = previous_category_revenue.sum()
...
if len(analysis_channel_revenue) > 0 and len(previous_channel_revenue) > 0:
    ...
    if top_channel_analysis and top_channel_analysis in previous_channel_revenue.index:
        analysis_top_ch_rev = analysis_channel_revenue[top_channel_analysis]
        previous_top_ch_rev = previous_channel_revenue[top_channel_analysis]
        ...
        analysis_top_ch_txns = analysis_channel_txns.get(top_channel_analysis, 0)
        previous_top_ch_txns = previous_channel_txns.get(top_channel_analysis, 0)
        
        analysis_total_ch_rev = analysis_channel_revenue.sum()
        previous_total_ch_rev = previous_channel_revenue.sum()
