    ...
    finding_2 = {
        ...
        "metrics": {
            ...
            "english_positive_count": {
                ...
                "denominator": int(len(english_reviews)) if len(english_reviews) > 0 else None,
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            ...
            "arabic_positive_count": {
                ...
                "denominator": int(len(arabic_reviews)) if len(arabic_reviews) > 0 else None,
                "period_start": analysis_start,
                "period_end": analysis_end
            },
...
if len(reviews_analysis) > 0:
    ...
    finding_3 = {
        ...
        "metrics": {
            "total_sources": {
                "value": int(len(source_counts)),
                "unit": "count",
                "numerator": int(len(source_counts)),
                "denominator": None,
                "period_start": analysis_start,
                "period_end": analysis_end
            }
