...
# Analysis period
analysis_start = pd.Timestamp('2026-06-01', tz=tz)
analysis_end = pd.Timestamp('2026-06-08', tz=tz)
previous_start = pd.Timestamp('2026-05-25', tz=tz)
previous_end = pd.Timestamp('2026-06-01', tz=tz)
