...
if len(reviews_analysis) > 0:
    ...
    finding_1 = {
        ...
        "claim": f"During {analysis_start[:10]} to {analysis_end[:10]}, {int(len(reviews_analysis))} reviews were collected with an average rating of {float(avg_rating):.2f} out of 5.0.",
        ...
        "coverage_notes": [
            ...
            f"Total reviews in analysis period: {int(len(reviews_analysis))}",
...
if len(reviews_analysis) > 0:
    ...
    finding_2 = {
        ...
        "claim": f"Of {int(len(reviews_analysis))} reviews in the analysis period, {int(language_counts.get('en', 0))} are in English and {int(language_counts.get('ar', 0))} are in Arabic.",
        ...
        "metrics": {
            ...
            "english_percentage": {
                "value": float(round(100 * language_counts.get('en', 0) / len(reviews_analysis), 1)) if len(reviews_analysis) > 0 else 0.0,
                "unit": "percent",
                "numerator": int(language_counts.get('en', 0)),
                "denominator": int(len(reviews_analysis)),
                "period_start": analysis_start,
            ...
            "arabic_percentage": {
                "value": float(round(100 * language_counts.get('ar', 0) / len(reviews_analysis), 1)) if len(reviews_analysis) > 0 else 0.0,
                "unit": "percent",
                "numerator": int(language_counts.get('ar', 0)),
                "denominator": int(len(reviews_analysis)),
                "period_start": analysis_start,
        ...
        "coverage_notes": [
            f"Analysis period: {analysis_start[:10]} to {analysis_end[:10]}",
            f"Language field populated for all {int(len(reviews_analysis))} reviews"
        ],
        "assumptions": [
...
if len(reviews_analysis) > 0:
    ...
    if len(reviews_with_text) > 0:
        ...
        finding_3 = {
            ...
            "claim": f"Of {int(len(reviews_with_text))} reviews with text content in the analysis period, {positive_count} exhibit positive sentiment, {negative_count} exhibit negative sentiment, and {neutral_count} are neutral or mixed.",
            ...
            "metrics": {
                ...
                "negative_sentiment_count": {
                    ...
                    "unit": "count",
                    "numerator": int(negative_count),
                    "denominator": int(len(reviews_with_text)),
                    "period_start": analysis_start,
                    "period_end": analysis_end
                },
                "neutral_sentiment_count": {
                    "value": int(neutral_count),
                    "unit": "count",
                    "numerator": int(neutral_count),
                    "denominator": int(len(reviews_with_text)),
                    "period_start": analysis_start,
                    "period_end": analysis_end
                },
                "positive_percentage": {
                    "value": float(round(100 * positive_count / len(reviews_with_text), 1)) if len(reviews_with_text) > 0 else 0.0,
                    "unit": "percent",
                    "numerator": int(positive_count),
                    "denominator": int(len(reviews_with_text)),
                    "period_start": analysis_start,
            ...
            "coverage_notes": [
                f"Analysis period: {analysis_start[:10]} to {analysis_end[:10]}",
                f"Reviews with non-empty text: {int(len(reviews_with_text))} of {int(len(reviews_analysis))}",
