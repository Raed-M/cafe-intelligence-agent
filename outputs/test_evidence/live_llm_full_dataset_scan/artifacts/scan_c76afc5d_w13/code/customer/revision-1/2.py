...
# If the date column is tz-naive, localize it to UTC+3; if tz-aware, convert to UTC+3
if reviews_df['date'].dt.tz is None:
    reviews_df['date'] = reviews_df['date'].dt.tz_localize('UTC+03:00', ambiguous='raise', nonexistent='raise')
else:
    reviews_df['date'] = reviews_df['date'].dt.tz_convert('UTC+03:00')

# Also ensure analysis_start_dt and analysis_end_dt are in the same timezone
