...
if total_reviews > 0:
    finding1 = {
        ...
        "claim": f"Average rating is {avg_rating:.2f} out of 5 across {total_reviews} reviews in the analysis period (2026-04-06 to 2026-04-13). Rating distribution shows {rating_counts.get(5, 0)} five-star, {rating_counts.get(4, 0)} four-star, {rating_counts.get(3, 0)} three-star, {rating_counts.get(2, 0)} two-star, and {rating_counts.get(1, 0)} one-star reviews.",
...
if topic_counts and total_reviews > 0:
    ...
    finding3 = {
        ...
        "metrics": {
            ...
            "top_topic_mentions": {
                "value": top_topics[0][1] if top_topics else 0,
                "unit": "count",
                "numerator": top_topics[0][1] if top_topics else 0,
                "denominator": total_reviews,
                "period_start": "2026-04-06T00:00:00+03:00",
                "period_end": "2026-04-13T00:00:00+03:00"
            }
