...
if len(reviews_period) > 0:
    ...
    finding2 = {
        ...
        "claim": f"Average rating across {total_reviews} reviews is {avg_rating} out of 5, with distribution: {{1: {complete_rating_dist[1]}, 2: {complete_rating_dist[2]}, 3: {complete_rating_dist[3]}, 4: {complete_rating_dist[4]}, 5: {complete_rating_dist[5]}}}. Rating {most_common_rating} is most common with {most_common_rating_count} reviews.",
        "finding_type": "voice_of_customer",
        "metrics": {
            "average_rating": {
                "value": avg_rating,
        ...
        "coverage_notes": [
            ...
            f"No reviews received ratings of 2 or 3" if complete_rating_dist[2] == 0 and complete_rating_dist[3] == 0 else ""
        ],
        "assumptions": [
