...
# If analysis dates are timezone-aware, convert review dates to UTC then localize
if analysis_start_dt.tz is not None:
    # Analysis dates are timezone-aware
    if reviews_df['date'].dt.tz is None:
        # Review dates are naive, assume UTC and localize
    ...
    # Analysis dates are naive, remove timezone from review dates if present
