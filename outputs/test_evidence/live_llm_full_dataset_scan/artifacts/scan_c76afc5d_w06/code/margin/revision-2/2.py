...
# Parse period dates with timezone awareness
...
# Ensure timezone-aware comparisons: convert naive datetimes to UTC then to +03:00
if pos_df['timestamp'].dt.tz is None:
    pos_df['timestamp'] = pos_df['timestamp'].dt.tz_localize('UTC').dt.tz_convert('+03:00')
else:
    pos_df['timestamp'] = pos_df['timestamp'].dt.tz_convert('+03:00')
...
if inventory_df['week_starting'].dt.tz is None:
    ...
    inventory_df['week_starting'] = inventory_df['week_starting'].dt.tz_convert('+03:00')
...
if emails_df['effective_date'].dt.tz is None:
    ...
    emails_df['effective_date'] = emails_df['effective_date'].dt.tz_convert('+03:00')

if emails_df['date'].dt.tz is None:
    emails_df['date'] = emails_df['date'].dt.tz_localize('UTC').dt.tz_convert('+03:00')
else:
    emails_df['date'] = emails_df['date'].dt.tz_convert('+03:00')
...
analysis_week = pd.to_datetime("2026-02-16").tz_localize('UTC').tz_convert('+03:00')
