...
# Analysis period
analysis_start = pd.Timestamp('2026-02-16T00:00:00', tz=tz)
analysis_end = pd.Timestamp('2026-02-23T00:00:00', tz=tz)
previous_start = pd.Timestamp('2026-02-09T00:00:00', tz=tz)
previous_end = pd.Timestamp('2026-02-16T00:00:00', tz=tz)
