...
if len(baseline_hourly_traffic_list) > 0:
    ...
    # Calculate z-scores
    analysis_hourly_traffic['baseline_mean'] = analysis_hourly_traffic['hour'].dt.floor('H').map(baseline_hourly_combined)
    analysis_hourly_traffic['baseline_std'] = analysis_hourly_traffic['hour'].dt.floor('H').map(baseline_hourly_std)
