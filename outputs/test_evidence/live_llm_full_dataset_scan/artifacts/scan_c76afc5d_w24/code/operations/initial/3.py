...
# Convert analysis dates to date objects for comparison
...
traffic_previous = traffic_df[(traffic_df['date'].dt.date >= previous_start_date) & (traffic_df['date'].dt.date < previous_end_date)].copy()
staff_previous = staff_df[(staff_df['date'].dt.date >= previous_start_date) & (staff_df['date'].dt.date < previous_end_date)].copy()
