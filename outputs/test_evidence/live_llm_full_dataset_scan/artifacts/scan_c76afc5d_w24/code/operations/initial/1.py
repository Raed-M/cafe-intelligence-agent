...
# Analysis period
analysis_start = pd.Timestamp('2026-06-22', tz=tz)
analysis_end = pd.Timestamp('2026-06-29', tz=tz)
previous_start = pd.Timestamp('2026-06-15', tz=tz)
previous_end = pd.Timestamp('2026-06-22', tz=tz)
