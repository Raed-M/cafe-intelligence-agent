...
staff_analysis = staff_df[
    (staff_df['date'] >= analysis_start_utc) & 
    (staff_df['date'] < analysis_end_utc)
]
...
staff_prev = staff_df[
    (staff_df['date'] >= prev_start_utc) & 
    (staff_df['date'] < prev_end_utc)
]
...
inv_analysis = inventory_df[inventory_df['week_starting'] >= analysis_start_utc]
if len(inv_analysis) > 0:
    ...
    inv_prev = inventory_df[
        (inventory_df['week_starting'] >= prev_start_utc) & 
