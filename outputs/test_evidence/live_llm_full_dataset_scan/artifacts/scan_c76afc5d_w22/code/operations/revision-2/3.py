...
# Filter staff for analysis period - convert datetime to date for comparison
staff_analysis = staff_df[
    (staff_df['date'].dt.date >= analysis_start.date()) & 
    (staff_df['date'].dt.date < analysis_end.date())
]
labour_cost_analysis = staff_analysis['labour_cost_sar'].sum()

# Filter staff for previous period
staff_previous = staff_df[
    (staff_df['date'].dt.date >= previous_start.date()) & 
    (staff_df['date'].dt.date < previous_end.date())
]
