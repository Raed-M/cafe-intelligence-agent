...
analysis_start = tz.localize(datetime(2026, 6, 8, 0, 0, 0))
analysis_end = tz.localize(datetime(2026, 6, 15, 0, 0, 0))
previous_start = tz.localize(datetime(2026, 6, 1, 0, 0, 0))
previous_end = tz.localize(datetime(2026, 6, 8, 0, 0, 0))
...
pos_df['business_date_dt'] = pd.to_datetime(pos_df['business_date']).dt.tz_localize(tz)
