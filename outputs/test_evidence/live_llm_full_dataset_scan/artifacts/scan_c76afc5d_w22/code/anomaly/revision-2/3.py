...
analysis_daily = daily_revenue[
    (daily_revenue['date'] >= pd.Timestamp(analysis_start.date())) & 
    (daily_revenue['date'] < pd.Timestamp(analysis_end.date()))
]

baseline_daily = daily_revenue[
    (daily_revenue['date'] >= pd.Timestamp(baseline_periods[0][0].date())) & 
    (daily_revenue['date'] < pd.Timestamp(baseline_periods[0][1].date()))
]
...
analysis_traffic = traffic_clean[
    (traffic_clean['date'] >= pd.Timestamp(analysis_start.date())) & 
    (traffic_clean['date'] < pd.Timestamp(analysis_end.date()))
]

baseline_traffic = traffic_clean[
    (traffic_clean['date'] >= pd.Timestamp(baseline_periods[0][0].date())) & 
    (traffic_clean['date'] < pd.Timestamp(baseline_periods[0][1].date()))
]
...
analysis_volume = daily_volume[
    (daily_volume['date'] >= pd.Timestamp(analysis_start.date())) & 
    (daily_volume['date'] < pd.Timestamp(analysis_end.date()))
]

baseline_volume = daily_volume[
    (daily_volume['date'] >= pd.Timestamp(baseline_periods[0][0].date())) & 
    (daily_volume['date'] < pd.Timestamp(baseline_periods[0][1].date()))
]
