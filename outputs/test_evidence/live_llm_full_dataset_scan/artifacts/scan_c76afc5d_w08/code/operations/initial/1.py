...
# Analysis period
analysis_start = pd.Timestamp('2026-03-02', tz=tz)
analysis_end = pd.Timestamp('2026-03-09', tz=tz)
previous_start = pd.Timestamp('2026-02-23', tz=tz)
previous_end = pd.Timestamp('2026-03-02', tz=tz)
...
analysis_week = pd.Timestamp('2026-03-02', tz=tz)
previous_week = pd.Timestamp('2026-02-23', tz=tz)

inventory_analysis = inventory_df[inventory_df['week_starting'] == analysis_week.date()].copy()
inventory_previous = inventory_df[inventory_df['week_starting'] == previous_week.date()].copy()
