...
analysis_product['launch_date'] = pd.to_datetime(analysis_product['launch_date'], errors='coerce', utc=True)
analysis_product['retire_date'] = pd.to_datetime(analysis_product['retire_date'], errors='coerce', utc=True)
...
analysis_eligible = analysis_product[
    (analysis_product['launch_date'].isna() | (analysis_product['launch_date'] < analysis_start_utc)) &
    (analysis_product['retire_date'].isna() | (analysis_product['retire_date'] >= analysis_start_utc))
]

previous_product['launch_date'] = pd.to_datetime(previous_product['launch_date'], errors='coerce', utc=True)
previous_product['retire_date'] = pd.to_datetime(previous_product['retire_date'], errors='coerce', utc=True)

previous_eligible = previous_product[
    (previous_product['launch_date'].isna() | (previous_product['launch_date'] < previous_start_utc)) &
    (previous_product['retire_date'].isna() | (previous_product['retire_date'] >= previous_start_utc))
]
