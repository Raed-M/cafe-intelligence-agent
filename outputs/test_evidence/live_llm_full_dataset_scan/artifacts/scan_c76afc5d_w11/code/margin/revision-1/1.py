...
if len(waste_records) > 0:
    ...
    finding_2 = {
        ...
        "assumptions": [
            "Waste units represent actual inventory loss (spoilage, disposal, shrinkage)",
            "known_waste_cost_sar reflects true economic cost of waste",
...
price_changes = emails_df[
    ...
    (emails_df['effective_date'] <= analysis_end_dt)
].copy()
