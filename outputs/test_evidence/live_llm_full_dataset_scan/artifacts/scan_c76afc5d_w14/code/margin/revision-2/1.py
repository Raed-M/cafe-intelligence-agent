...
# ============================================================================
# FINDING 1: Item-level gross profit contribution (top items by absolute profit)
# ============================================================================
...
if len(top_3_items) >= 1:
    top_item = top_3_items.iloc[0]
    
    finding_1 = {
        "title": "Top item by gross profit contribution",
        "claim": f"In the week of {analysis_start} to {analysis_end}, {top_item['item_name']} generated the highest gross profit contribution at SAR {top_item['total_gross_profit']:.2f} with a gross margin of {top_item['margin_pct']:.1f}%.",
        ...
        "metrics": {
            ...
            "top_item_gross_margin_pct": {
                "value": round(top_item['margin_pct'], 1),
                "unit": "%",
                "numerator": round(top_item['total_gross_profit'], 2),
...
if len(inv_with_waste) > 0:
    ...
    finding_3 = {
        ...
        "claim": f"During the week of {analysis_start} to {analysis_end}, quantified waste cost totaled SAR {total_waste_cost:.2f} across {waste_item_count} items ({int(total_waste_units)} units), representing {waste_pct_of_cogs:.1f}% of inventory-based COGS.",
        ...
        "assumptions": [
            ...
            "Waste percentage calculated against inventory-derived COGS, not POS-derived COGS"
        ],
        "confidence": 0.75
    }
