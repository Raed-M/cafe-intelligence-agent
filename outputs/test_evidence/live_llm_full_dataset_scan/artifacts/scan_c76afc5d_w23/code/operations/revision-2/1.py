...
previous_start = tz.localize(datetime(2026, 6, 8, 0, 0, 0))
previous_end = tz.localize(datetime(2026, 6, 15, 0, 0, 0))
...
def calculate_conversion(pos_data, traffic_data, period_start, period_end):
    ...
    traffic_period = traffic_data[(traffic_data['date'] >= period_start.date()) & 
                                   (traffic_data['date'] < period_end.date()) &
...
def calculate_labour_cost(staff_data, period_start, period_end):
    ...
    staff_period = staff_data[(staff_data['date'] >= period_start.date()) & 
                              (staff_data['date'] < period_end.date())]
    ...
    findings.append({
        ...
        "metrics": {
            ...
            "conversion_change_pct": {
                "value": round(conv_change_pct, 2) if conv_change_pct is not None else None,
                "unit": "percent",
                "numerator": None,
                "denominator": None,
                "period_start": "2026-06-08T00:00:00+03:00",
    ...
    findings.append({
        ...
        "metrics": {
            ...
            "labour_ratio_change_pct": {
                "value": round(labour_ratio_change_pct, 2),
                "unit": "percent",
                "numerator": None,
                "denominator": None,
                "period_start": "2026-06-08T00:00:00+03:00",
    ...
    findings.append({
        ...
        "metrics": {
            ...
            "waste_ratio_change_pct": {
                "value": round(waste_ratio_change_pct, 2) if waste_ratio_change_pct is not None else None,
                "unit": "percent",
                "numerator": None,
                "denominator": None,
                "period_start": "2026-06-08T00:00:00+03:00",
