...
if len(analysis_reviews) > 0:
    ...
    finding1 = {
        ...
        "claim": f"During the analysis period (2026-06-15 to 2026-06-22), the average rating across {len(analysis_reviews)} reviews was {avg_rating:.2f} out of 5.0. Rating distribution: 1-star: {rating_counts_dict.get(1, 0)} reviews, 2-star: {rating_counts_dict.get(2, 0)} reviews, 3-star: {rating_counts_dict.get(3, 0)} reviews, 4-star: {rating_counts_dict.get(4, 0)} reviews, 5-star: {rating_counts_dict.get(5, 0)} reviews.",
        ...
        "metrics": {
            ...
            "rating_1_star_count": {
                "value": int(rating_counts_dict.get(1, 0)),
                "unit": "reviews",
                "numerator": int(rating_counts_dict.get(1, 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "rating_2_star_count": {
                "value": int(rating_counts_dict.get(2, 0)),
                "unit": "reviews",
                "numerator": int(rating_counts_dict.get(2, 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "rating_3_star_count": {
                "value": int(rating_counts_dict.get(3, 0)),
                "unit": "reviews",
                "numerator": int(rating_counts_dict.get(3, 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "rating_4_star_count": {
                "value": int(rating_counts_dict.get(4, 0)),
                "unit": "reviews",
                "numerator": int(rating_counts_dict.get(4, 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            },
            "rating_5_star_count": {
                "value": int(rating_counts_dict.get(5, 0)),
                "unit": "reviews",
                "numerator": int(rating_counts_dict.get(5, 0)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
                "period_end": analysis_end
            }
...
if len(analysis_reviews) > 0:
    ...
    # Convert numpy int64 to Python int for JSON serialization
    language_counts_dict = {str(k): int(v) for k, v in language_counts.items()}
    
    finding2 = {
        "title": "Review Language Distribution",
        "claim": f"During the analysis period, reviews were submitted in {len(language_counts)} languages. Language breakdown: {', '.join([f'{lang}: {count} reviews' for lang, count in language_counts_dict.items()])}.",
        "finding_type": "language_distribution",
        "metrics": {
            "total_reviews_by_language": {
                "value": language_counts_dict,
                "unit": "reviews",
                "numerator": int(len(analysis_reviews)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
...
if len(analysis_reviews) > 0:
    ...
    finding3 = {
        ...
        "claim": f"During the analysis period, reviews came from {len(source_counts)} sources. Source breakdown: {', '.join([f'{source}: {count} reviews' for source, count in source_counts_dict.items()])}.",
        "finding_type": "source_distribution",
        "metrics": {
            "reviews_by_source": {
                "value": source_counts_dict,
                "unit": "reviews",
                "numerator": int(len(analysis_reviews)),
                "denominator": int(len(analysis_reviews)),
                "period_start": analysis_start,
