        ...
        findings.append({
            ...
            'metrics': {
                'observed_units_wasted': {
                    ...
                    'period_end': (pd.Timestamp(analysis_week_start) + timedelta(days=7)).date().isoformat()
                },
                'baseline_mean_waste': {
                    ...
                    'numerator': None,
                    'denominator': None,
                    'period_start': baseline_periods[0][0].date().isoformat(),
                    'period_end': baseline_periods[-1][1].date().isoformat()
                },
                'z_score': {
            ...
            'coverage_notes': [
                ...
                'Analysis week: 2026-05-04 to 2026-05-11'
            ],
            'assumptions': [
