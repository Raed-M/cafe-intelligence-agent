...
# Create timezone-aware datetimes using fixed offset
from datetime import timezone as dt_timezone
riyadh_tz = dt_timezone(timedelta(hours=3))

analysis_start = datetime(2026, 2, 23, 0, 0, 0, tzinfo=riyadh_tz)
analysis_end = datetime(2026, 3, 2, 0, 0, 0, tzinfo=riyadh_tz)
prev_start = datetime(2026, 2, 16, 0, 0, 0, tzinfo=riyadh_tz)
prev_end = datetime(2026, 2, 23, 0, 0, 0, tzinfo=riyadh_tz)
