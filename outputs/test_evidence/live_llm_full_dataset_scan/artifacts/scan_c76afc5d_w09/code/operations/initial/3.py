...
# Analysis period (using UTC timestamps with Riyadh offset)
analysis_start = pd.Timestamp('2026-03-09T00:00:00', tz='UTC')
analysis_end = pd.Timestamp('2026-03-16T00:00:00', tz='UTC')
previous_start = pd.Timestamp('2026-03-02T00:00:00', tz='UTC')
previous_end = pd.Timestamp('2026-03-09T00:00:00', tz='UTC')
...
previous_start_date = pd.Timestamp(previous_start.date())
...
staff_previous_metrics = calculate_staffing(staff_df[(staff_df['date'] >= previous_start_date) & (staff_df['date'] < previous_end_date)], 'previous')
