            ...
            findings.append({
                ...
                'metrics': {
                    'daily_revenue': {
                        ...
                        'period_end': (anomaly_date + timedelta(days=1)).isoformat()
                    },
                    'baseline_mean': {
            ...
            findings.append({
                ...
                'metrics': {
                    'hourly_door_count': {
                        ...
                        'numerator': None,
                        'denominator': None,
                        'period_start': str(anomaly_hour_traffic['hour']),
                        'period_end': str(anomaly_hour_traffic['hour'] + timedelta(hours=1))
                    },
            ...
            findings.append({
                ...
                'metrics': {
                    'daily_transaction_count': {
                        ...
                        'numerator': None,
                        'denominator': None,
                        'period_start': anomaly_date_txn.isoformat(),
                        'period_end': (anomaly_date_txn + timedelta(days=1)).isoformat()
                    },
